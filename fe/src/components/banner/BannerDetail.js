...
import '../../styles/banner/BannerDetail.css';
        ...
        <div className="update-banner-container" >
            <div className="container">
                <div className="header-top">
                    <p className="mt-4 text-left" > Admin <BiIcons.BiChevronRight size={20} /> <a href="/banner/manage">Quản lý banner</a>  <BiIcons.BiChevronRight size={20} /> Thông tin banner</p>
                </div>
                <hr></hr>
                <div className="main-content">
                    <div className="row">
                        ...
                        <div className="col-sm-6 right">
                            <div className="col-sm-12">
                                <h1 className="text-center">Ảnh banner</h1>
                            </div>
